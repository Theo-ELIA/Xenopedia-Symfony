...
namespace Proxies\__CG__\Xenopedia\SiteBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class minorite extends \Xenopedia\SiteBundle\Entity\minorite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'dateAjout', 'urlImage', 'cliches', 'categories');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (minorite $proxy) {
    ...
    public function setUrlImage($url)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUrlImage', array($url));

        return parent::setUrlImage($url);
    }
    ...
    public function setCliches(\Doctrine\Common\Collections\ArrayCollection $cliche)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCliches', array($cliche));

        return parent::setCliches($cliche);
    }

    /**
     * {@inheritDoc}
     */
    public function addCategorie(\Xenopedia\SiteBundle\Entity\categorieMinorite $categorie)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategorie(\Xenopedia\SiteBundle\Entity\categorieMinorite $categorie)
    {
