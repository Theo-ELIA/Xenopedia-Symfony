...
class __TwigTemplate_8e37f6919730ea357e51f66f008deada extends Twig_Template
{
...
";
    ...
    {
        // line 2
        if ($this->getContext($context, "is_human")) {
            // line 3
            echo "-
";
        } else {
            ...
            // line 6
            echo "    <img id=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "image_id"), "html", null, true);
            echo "\" src=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "captcha_code"), "html", null, true);
            echo "\" alt=\"\" title=\"captcha\" width=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "captcha_width"), "html", null, true);
            echo "\" height=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "captcha_height"), "html", null, true);
            echo "\" />
    ";
            // line 7
            if ($this->getContext($context, "reload")) {
                // line 8
