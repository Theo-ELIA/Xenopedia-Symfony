...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator.default'), array('length' => 5, 'width' => 130, 'height' => 50, 'font' => 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle\\DependencyInjection/../Generator/Font/captcha.ttf', 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'as_url' => false, 'reload' => false, 'image_folder' => 'captcha', 'web_path' => 'C:/wamp/www/Symfony/app/../web', 'gc_freq' => 100, 'expiration' => 60, 'quality' => 30, 'invalid_message' => 'Bad code value', 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'distortion' => true, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true, 'background_color' => array()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'xenopedia', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51b1ff826c310_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51b1ff826c310_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/wamp/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_51b1ff826c310.php';
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\SiteBundle\\Entity', 1 => 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\UserBundle\\Entity'));
        ...
        $g->addDriver($e, 'Xenopedia\\SiteBundle\\Entity');
        $g->addDriver($e, 'Xenopedia\\UserBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');
        $g->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('XenopediaSiteBundle' => 'Xenopedia\\SiteBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'XenopediaUserBundle' => 'Xenopedia\\UserBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51b1ff826c310_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'cc6912177fa121cd4efe73e03f3d5d11455159c4');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Xenopedia\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Xenopedia\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'xenopedia_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Xenopedia\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Xenopedia\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Xenopedia\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['gravatar.api'] = new \Ornicar\GravatarBundle\GravatarApi(array('default' => 'retro', 'size' => '80', 'rating' => 'g'));
    }
    ...
    {
        return $this->services['gregwar_captcha.image_file_handler'] = new \Gregwar\CaptchaBundle\Generator\ImageFileHandler('captcha', 'C:/wamp/www/Symfony/app/../web', 100, 60);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Xenopedia\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/member');
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'cc6912177fa121cd4efe73e03f3d5d11455159c4', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\SiteBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        ...
        $instance->addResource('xlf', 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\UserBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\UserBundle/Resources/translations\\messages.fr.yml', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\Symfony\\src\\Xenopedia\\AdminBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\gregwar_captcha.es.yml', 'es', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\gregwar_captcha.fr.yml', 'fr', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\gregwar_captcha.it.yml', 'it', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\gregwar_captcha.ro.yml', 'ro', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\gregwar_captcha.zh_CN.yml', 'zh_CN', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Xenopedia\\SiteBundle/Resources/views', 'XenopediaSite');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Xenopedia\\UserBundle/Resources/views', 'XenopediaUser');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Xenopedia\\AdminBundle/Resources/views', 'XenopediaAdmin');
        $instance->addPath('C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle/Resources/views', 'GregwarCaptcha');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cc6912177fa121cd4efe73e03f3d5d11455159c4');
    }
    ...
    /**
     * Gets the 'xenopedia_user_registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Xenopedia\UserBundle\Form\Type\RegistrationFormType A Xenopedia\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getXenopediaUserRegistration_Form_TypeService()
    {
        return $this->services['xenopedia_user_registration.form.type'] = new \Xenopedia\UserBundle\Form\Type\RegistrationFormType('Xenopedia\\UserBundle\\Entity\\User');
    }
     ...
     *
     * @return EntityManager51b1ff826c310_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'XenopediaSiteBundle' => 'Xenopedia\\SiteBundle\\XenopediaSiteBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'XenopediaUserBundle' => 'Xenopedia\\UserBundle\\XenopediaUserBundle',
                'XenopediaAdminBundle' => 'Xenopedia\\AdminBundle\\XenopediaAdminBundle',
            ...
            'locale' => 'fr',
            'secret' => 'cc6912177fa121cd4efe73e03f3d5d11455159c4',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'cc6912177fa121cd4efe73e03f3d5d11455159c4',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/wamp/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_51b1ff826c310.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51b1ff826c310_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'fos_user.model.user.class' => 'Xenopedia\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'xenopedia_user_registration',
            ...
            'gregwar_captcha.config' => array(
                ...
                'width' => 130,
                'height' => 50,
                'font' => 'C:\\wamp\\www\\Symfony\\vendor\\gregwar\\captcha-bundle\\Gregwar\\CaptchaBundle\\DependencyInjection/../Generator/Font/captcha.ttf',
                'keep_value' => false,
                ...
                'web_path' => 'C:/wamp/www/Symfony/app/../web',
                'gc_freq' => 100,
                'expiration' => 60,
                'quality' => 30,
            ...
            'gregwar_captcha.config.web_path' => 'C:/wamp/www/Symfony/app/../web',
